...
var incompleteTaskHolder=document.querySelector(".tasks-list_uncomplete");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".tasks-list_complete");//completed-tasks
